...
messageEditor.prototype = {
	...
	initialize: function(textarea, options)
	{
		...
		if(DaddyoBB.browser == "konqueror" || (typeof(DADDYOBB_editor_disabled) != "undefined" && DADDYOBB_editor_disabled == true))
		{
			return false;
		}
	...
	showEditor: function()
	{
		...
		subtract = 16;
		if(DaddyoBB.browser == 'ie') subtract += 5;
		subtract2 = 7;
		if(DaddyoBB.browser == 'ie') subtract2 += 6;
	...
	storeCaret: function()
	{
		if(DaddyoBB.browser != 'ie' || !this.trackingCaret)
		{
			return;
		}
	...
	{
		DaddyoBB.popupWindow('misc.php?action=smilies&popup=true&editor='+editor, 'sminsert', 240, 280);
	},

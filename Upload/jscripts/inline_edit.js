...
inlineEditor.prototype = {
	...
	showTextbox: function()
	{
		...
		this.textbox.value = DaddyoBB.unHTMLchars(this.oldValue);
	...
	hideTextbox: function()
	{
		...
		if(typeof(newValue) != "undefined" && newValue != '' && DaddyoBB.HTMLchars(newValue) != this.oldValue)
		{
			this.testNode.innerHTML = this.cache;
			
			this.element = $(this.currentElement);
			this.element.innerHTML = DaddyoBB.HTMLchars(newValue);
	...
	onComplete: function(request)
	{
		...
		{
			this.element.innerHTML = DaddyoBB.HTMLchars(request.responseText);
		}

...
if(!empty($main_field))
{
	$tables[] = "DROP SEQUENCE daddyobb_userfields_ufid_seq;";
}
$tables[] = "CREATE SEQUENCE daddyobb_userfields_ufid_seq;";
...
$tables[] = "CREATE TABLE daddyobb_usergroups (
  ...
  sigallowmycode int NOT NULL default '1',
  sigallowimgcode int NOT NULL default '1',
  sigallowsmilies int NOT NULL default '1',
  sigallowhtml int NOT NULL default '0',  
  canpostpolls int NOT NULL default '0',
  canvotepolls int NOT NULL default '0',
  canusevms int NOT NULL default '1',
  caneditownvms int NOT NULL default '1',
  candeleteownvms int NOT NULL default '1',
  canmanagevms int NOT NULL default '1',  
  ...
  canuploadavatars int NOT NULL default '1',
  canuploadprofilepics int NOT NULL default '1',
  ...
  canhtmlintitle int NOT NULL default '0',
  ...
  modcanannouncements int NOT NULL default '0',
  modcanviewmodlogs int NOT NULL default '0',
  modcanmanagevms int NOT NULL default '0',
  modcanmanageprofiles int NOT NULL default '0',
  modcanbanusers int NOT NULL default '0',
  PRIMARY KEY (gid)
);";
...
$tables[] = "CREATE TABLE daddyobb_users (
  ...
  enablevms int NOT NULL default '1',
  limitvms int NOT NULL default '0',  

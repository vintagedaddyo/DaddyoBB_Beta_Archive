...
$l['title'] = "DaddyoBB Installation Wizard";
$l['welcome'] = 'Welcome';
...
$l['already_installed'] = "DaddyoBB is already installed";
$l['daddyobb_already_installed'] = "<p>Welcome to the installation wizard for DaddyoBB {1}. DaddyoBB has detected it is already configured this directory.</p>
<p>Please choose a suitable action below:</p>

<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	<h3>Upgrade my existing copy of DaddyoBB to {1} <span style=\"font-size: 80%; color: maroon;\">(Recommended)</span></h3>
	<p>This option will upgrade your current version of DaddyoBB to DaddyoBB {1}.</p>
	...
	<form method=\"post\" action=\"upgrade.php\">
		<div class=\"next_button\"><input type=\"submit\" class=\"submit_button\" value=\"Upgrade to DaddyoBB {1} &raquo;\" /></div>
	</form>
</div>

<div style=\"padding: 4px;\">
	<h3>Install a new copy of DaddyoBB</h3>
	<p>This option will <span style=\"color: red;\">delete any existing forum you may have set up</span> and install a fresh version of DaddyoBB.</p>
	<p>You should choose this option to erase your existing copy of DaddyoBB if you wish to start again.</p>
	<form method=\"post\" action=\"index.php\" onsubmit=\"return confirm('Are you sure you wish to install a fresh copy of DaddyoBB?\\n\\nThis will delete your existing forum. THIS PROCESS CANNOT BE UNDONE.');\">
		<input type=\"hidden\" name=\"action\" value=\"intro\" />
		<div class=\"next_button\"><input type=\"submit\" class=\"submit_button\" value=\"Install DaddyoBB {1} &raquo;\" /></div>
	</form>
</div>";

$l['daddyobb_incorrect_folder'] = "<div class=\"border_wrapper upgrade_note\" style=\"padding: 4px;\">
	<h3>DaddyoBB has detected that it is running from the \"Upload\" directory.</h3>
	<p>While there is nothing wrong with this, it is recommended that your upload the contents of the \"Upload\" directory and not the directory itself.</p>
</div>";

$l['welcome_step'] = '<p>Welcome to the installation wizard for DaddyoBB {1}. This wizard will install and configure a copy of DaddyoBB on your server.</p>
<p>Now that you\'ve uploaded the DaddyoBB files the database and settings need to be created and imported. Below is an outline of what is going to be completed during installation.</p>
<ul>
	<li>DaddyoBB requirements checked</li>
...
<p>Click "Next" to view the DaddyoBB license agreement.</p>';

$l['license_step'] = '<div class="license_agreement">
{1}
</div>
<p><strong>By clicking Next, you agree to the terms stated in the DaddyoBB License Agreement above.</strong></p>';


$l['req_step_top'] = '<p>Before you can install DaddyoBB, we must check that you meet the minimum requirements for installation.</p>';
...
$l['req_step_reqcomplete'] = '<p><strong>Congratulations, you meet the requirements to run DaddyoBB.</strong></p>
...
$l['req_step_error_phpversion'] = 'DaddyoBB Requires PHP 4.1.0 or later to run. You currently have {1} installed.';
$l['req_step_error_dboptions'] = 'DaddyoBB requires one or more suitable database extensions to be installed. Your server reported that none were available.';
$l['req_step_error_xmlsupport'] = 'DaddyoBB requires PHP to be compiled with support for XML Data Handling. Please see <a href="http://www.php.net/xml" target="_blank">PHP.net</a> for more information.';
$l['req_step_error_configdefaultfile'] = 'The configuration file (inc/config.default.php) could not be renamed. Please manually rename the <u>config.default.php</u> file to <u>config.php</u> to allow it to be written to or contact <a href="http://mybboard.net/support" targert="_blank">DaddyoBB Support.</a>';
...
<h3>Error</h3>
<p>The DaddyoBB Requirements check failed due to the reasons below. DaddyoBB installation cannot continue because you did not meet the DaddyoBB requirements. Please correct the errors below and try again:</p>
{1}
</div>';


$l['db_step_config_db'] = '<p>It is now time to configure the database that DaddyoBB will use as well as your database authentication details. If you do not have this information, it can usually be obtained from your webhost.</p>';
...
<p>The DaddyoBB database tables will now be created.</p>';
...
$l['populate_step_inserted'] = '<p>The default data has successfully been inserted into the database. Click Next to insert the default DaddyoBB template and theme sets.</p>';
...
$l['config_step_table'] = '<p>It is now time for you to configure the basic settings for your forums such as forum name, URL, your website details, along with your "cookie" domain and paths. These settings can easily be changed in the future through the DaddyoBB Admin Control Panel.</p>
...
$l['config_step_error_name'] = 'You did not enter a name for your copy of DaddyoBB.';
...
$l['admin_step_createadmin'] ='<p>You need to create an initial administrator account for you to login and manage your copy of DaddyoBB. Please fill in the required fields below to create this account.</p>';
...
$l['done_step_success'] = '<p class="success">Your copy of DaddyoBB has successfully been installed and configured correctly.</p>
<p>The DaddyoBB Group thanks you for your support in installing our software and we hope to see you around the community forums if you need help or wish to become a part of the DaddyoBB community.</p>';
$l['done_step_locked'] = '<p>Your installer has been locked. To unlock the installer please delete the \'lock\' file in this directory.</p><p>You may now proceed to your new copy of <a href="../index.php">DaddyoBB</a> or its <a href="../admin/index.php">Admin Control Panel</a>.</p>';
$l['done_step_dirdelete'] = '<p><strong><span style="colour:red">Please remove this directory before exploring your copy of DaddyoBB.</span></strong></p>';

/* UPGRADE LANGUAGE VARIABLES */
$l['upgrade'] = "Upgrade Process";
$l['upgrade_welcome'] = "<p>Welcome to the upgrade wizard for DaddyoBB {1}.</p><p>Before you continue, please make sure you know which version of DaddyoBB you were previously running as you will need to select it below.</p><p><strong>We strongly recommend that you also obtain a complete backup of your database and files before attempting to upgrade</strong> so if something goes wrong you can easily revert back to the previous version.  Also, ensure that your backups are complete before proceeding.</p><p>Make sure you only click Next ONCE on each step of the upgrade process. Pages may take a while to load depending on the size of your forum.</p><p>Once you are ready, please select your old version below and click Next to continue.</p>";
...
$l['upgrade_settings_sync_success'] = "<p>The board settings have been synchronised with the latest in DaddyoBB.</p><p>{1} new settings inserted along with {2} new setting groups.</p><p>To finalise the upgrade, please click next below to continue.</p>";
...
$l['upgrade_locked'] = "<p>Your installer has been locked. To unlock the installer please delete the 'lock' file in this directory.</p><p>You may now proceed to your upgraded copy of <a href=\"../index.php\">DaddyoBB</a> or its <a href=\"../{1}/index.php\">Admin Control Panel</a>.</p>";
$l['upgrade_removedir'] = 'Please remove this directory before exploring your upgraded DaddyoBB.';
$l['upgrade_congrats'] = "<p>Congratulations, your copy of DaddyoBB has successfully been updated to {1}.</p>{2}<p><strong>What's Next?</strong></p><ul><li>Please use the 'Find Updated Templates' tool in the Admin CP to find customised templates updated during this upgrade process. Edit them to contain the changes or revert them to originals.</li><li>Ensure that your board is still fully functional.</li></ul>";

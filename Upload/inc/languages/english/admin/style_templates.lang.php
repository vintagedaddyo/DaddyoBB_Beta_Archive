...
$l['add_set'] = "Add Set";
$l['add_set_desc'] = "Here you can create a new template set. A new template set creates a copy of the master DaddyoBB templates and allows you to edit them without interfering with changes in any other template sets you may already have";
...
$l['find_updated_desc'] = "Allows you to find changed templates in new versions of DaddyoBB so you can properly apply the changes.";
...
$l['group_visitormessage'] = "Visitor Messaging";

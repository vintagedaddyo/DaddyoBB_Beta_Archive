...
$l['converting_to_utf8'] = "DaddyoBB is currently converting \"{1}\" table to UTF-8 language encoding from {2} encoding.";
...
$l['error_db_encoding_not_set'] = "Your current setup of DaddyoBB is not setup to use this tool yet. Please see <a href=\"http://wiki.mybboard.net/index.php/UTF8_Setup\">the wiki</a> for more information on how to set it up.";

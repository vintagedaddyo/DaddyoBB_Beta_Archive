...
$l['confirm_task_enable'] = "<strong>WARNING:</strong> You are about to enable a task that is only meant to be run via a cron (Please see the <a href=\"http://wiki.mybboard.net/\" target=\"_blank\">DaddyoBB Wiki</a> for more information). Continue?";

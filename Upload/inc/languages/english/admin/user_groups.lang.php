...
$l['general'] = "General";
$l['forums_posts'] = "Forums & Posts";
$l['users_permissions'] = "Users & Permissions";
$l['avatar_profilepic_signature'] = "Avatar, Profile Picture & Signature";
...
$l['viewing_options'] = "General Forum Permissions";
...
$l['posting_rating_options'] = "Post / Thread Permissions";
$l['can_post_threads'] = "Can Post Threads";
$l['can_post_replies'] = "Can Reply to Threads";
$l['can_rate_threads'] = "Can Rate Threads";
$l['poll_options'] = "Poll Permissions";
...
$l['can_use_html_usertitles'] = "Can use HTML in custom user titles?";
$l['reputation_system'] = "Reputation System";
$l['can_use_vms'] = "Can Post Visitor Messages<br /><small>If this is set to yes, users of this usergroup are not able to become visitor messages, too.</small>";
$l['can_edit_own_vms'] = "Can Edit Own Visitor Messages";
$l['can_delete_own_vms'] = "Can Delete Own Visitor Messages";
$l['can_manage_vms'] = "Can Manage Messages within Own Profile<br /><small>If this is set to yes, users of this usergroup have moderation rights on visitor messages posted on their profile.</small>";
$l['visitor_messaging'] = "Visitor Message Permissions";
...
$l['avatar_options'] = "Avatar Permissions";
$l['can_upload_avatars'] = "Can upload avatars?";
$l['avatar_max_size'] = "Maximum Image Size (in kilobytes)";
$l['avatar_max_dimensions'] = "Maximum Image Dimensions (width<strong>x</strong>height)";
$l['profilepic_options'] = "Profile Picture Permissions";
$l['can_upload_profilepics'] = "Can upload profile pictures?";
$l['profilepic_max_size'] = "Maximum Image Size (in kilobytes)";
$l['profilepic_max_dimensions'] = "Maximum Image Dimensions (width<strong>x</strong>height)";
$l['sig_max_chars'] = "Maximum Characters in Signature";
$l['sig_allow_mycode'] = "Allow MyCode";
$l['sig_allow_imgcode'] = "Allow IMG Code";
$l['sig_num_images'] = "Maximum Number of Images in Signature";
$l['sig_num_images_descr'] = "This controls the maximum number of images that users in this group may use in their signatures. This includes [img] tags and smilies. 0 means no limit.";
$l['sig_allow_smilies'] = "Allow Smilies";
$l['sig_allow_html'] = "Allow HTML";
$l['signature_options'] = "Signature Permissions";
$l['calendar'] = "Calendar";
...
$l['modcp'] = "Moderator Control Panel Permission";
$l['mod_can_announcements'] = "Can Manage Announcements";
$l['mod_can_view_modlogs'] = "Can View Moderation Logs";
$l['mod_can_manage_vms'] = "Can Manage Visitor Messages";
$l['mod_can_manage_profiles'] = "Can Manage User Profiles";
$l['mod_can_ban_users'] = "Can Ban User Profiles";

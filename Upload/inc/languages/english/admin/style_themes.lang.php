...
$l['ignore_version_compat_desc'] = "Should this theme be installed regardless of the version of DaddyoBB it was created for?";
...
$l['error_uploadfailed_nocontents'] = "DaddyoBB could not find the theme with the file you uploaded. Please check the file is the correct and is not corrupt.";
$l['error_invalid_version'] = "This theme has been written for another version of DaddyoBB. Please check the \"Ignore Version Compatibility\" to ignore this error.";
...
$l['error_cannot_parse'] = "DaddyoBB cannot parse this stylesheet for the simple editor. It can only be edited in advanced mode.";
